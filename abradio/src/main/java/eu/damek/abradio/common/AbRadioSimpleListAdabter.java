...
import eu.damek.abradio.activity.PlayerActivity;
import eu.damek.abradio.service.PlaybackService;


public class AbRadioSimpleListAdabter implements ListAdapter, OnClickListener, OnLongClickListener {
    ...
    public AbRadioSimpleListAdabter(PlaybackService player2, Context _context, int atype, ListView favList) {
        player = player2;
        type = atype;
        context = _context;
        lv = favList;
